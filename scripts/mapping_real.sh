...
missing_packages=()
for package in pointcloud_to_laserscan slam_toolbox robot_state_publisher; do
...
if ((${#missing_packages[@]} > 0)); then
  ...
  echo "  sudo apt install -y ros-humble-pointcloud-to-laserscan ros-humble-slam-toolbox ros-humble-robot-state-publisher" >&2
